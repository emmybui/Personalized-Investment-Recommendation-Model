...
PRIMARY_TEST_END = "2022-11-30 23:59:59"
...
# Stable ordering used by cleaning, splitting, loaders, and temporal graphs.
# transactionID alone is not globally unique in FAR-Trans.
TRANSACTION_KEY = ["customerID", "transactionID"]
EVENT_ORDER = ["timestamp", "customerID", "transactionID", "ISIN"]
